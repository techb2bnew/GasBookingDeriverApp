...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        private const val CHANNEL_ID = "driver_app_channel"
        private const val CHANNEL_NAME = "Driver App Notifications"
        private const val CHANNEL_DESCRIPTION = "Notifications for order updates and driver alerts"
    }
